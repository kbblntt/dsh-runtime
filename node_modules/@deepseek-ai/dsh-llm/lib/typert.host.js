...
const _deepseek_ai_dsh_llm_llm_probeModel_parameter_0$schema = z.string()
const _deepseek_ai_dsh_llm_llm_probeModel_parameter_1$schema = z.object({
  'provider': z.string().optional(),
  'baseURL': z.string().optional(),
  'api': z.string().optional(),
  'apiKey': z.string().optional(),
...
const _deepseek_ai_dsh_llm_llm_probeModel_result$schema = z.object({
  'latencyMs': z.number(),
  'model': z.string(),
})
...
export const TYPERT = {
  ...
  invocations: [
    ...
    {
      id: '@deepseek-ai/dsh-llm#llm/probeModel',
      service: 'llm',
      namespace: 'llm',
      method: 'probeModel',
      implementation: 'remoteProbeModel',
      invocation: { kind: 'direct' },
      parameters: [
        {
          name: 'settingsNs',
          ...
          codec: {
            mode: 'strict',
            typeSymbol: '@deepseek-ai/dsh-llm#llm/probeModel:settingsNs',
            schema: _deepseek_ai_dsh_llm_llm_probeModel_parameter_0$schema,
          },
        },
        {
          name: 'request',
          ...
          codec: {
            mode: 'strict',
            typeSymbol: '@deepseek-ai/dsh-llm/types#LlmModelProbeRequest',
            schema: _deepseek_ai_dsh_llm_llm_probeModel_parameter_1$schema,
          },
        },
      ],
      cancellation: { parameter: 'signal' },
      result: {
        mode: 'strict',
        typeSymbol: '@deepseek-ai/dsh-llm#llm/probeModel:result',
        schema: _deepseek_ai_dsh_llm_llm_probeModel_result$schema,
      },
      sourceLocation: {"file":"packages/llm/llm/src/index.ts","line":664,"column":9},
    },
    {
    ...
    "services": [
      {
        ...
        "members": [
          ...
          {
            "kind": "method",
            "name": "registerModelProbe",
            "signature": "registerModelProbe( settingsNs: string, probe: ( request: LlmModelProbeRequest, signal?: AbortSignal, ) => Promise<unknown>, ): () => void",
            "summary": "Offer to send one minimal completion probe on behalf of the settings namespace this plugin owns.",
          ...
          },
          {
            "kind": "method",
            "name": "probeModel",
            "signature": "async probeModel( settingsNs: string, request: LlmModelProbeRequest, signal?: AbortSignal, ): Promise<LlmModelProbeResult>",
            "summary": "Send one minimal completion probe against a draft endpoint and model.",
          ...
          },
          {
            ...
            "signature": "@Remote('probeModel') async remoteProbeModel( settingsNs: string, request: LlmModelProbeRequest, signal: AbortSignal, ): Promise<LlmModelProbeResult>",
            "summary": "Remote adapter for one draft model connectivity probe.",
        ...
        "types": [
          ...
          {
            "name": "LlmModelProbeRequest",
            "declaration": "export interface LlmModelProbeRequest {\n    provider?: string;\n    baseURL?: string;\n    api?: string;\n    apiKey?: string;\n    model: string;\n}"
          },
          {
            "name": "LlmModelProbeResult",
            "declaration": "export interface LlmModelProbeResult {\n    latencyMs: number;\n    model: string;\n}"
          },
          {
            "name": "LlmModelInfo",
