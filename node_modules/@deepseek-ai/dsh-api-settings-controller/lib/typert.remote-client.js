...
const _deepseek_ai_dsh_api_settings_controller_credentials_get_parameter_0$schema = z.string()
const _deepseek_ai_dsh_api_settings_controller_credentials_get_result$schema = z.object({
  'configured': z.boolean(),
  'source': z.string().optional(),
...
export const TYPERT_REMOTE = {
  ...
  descriptors: [
    ...
    },
    {
      ...
      sourceLocation: {"file":"packages/api/settings-controller/src/credentials.ts","line":134,"column":9},
    },
    {
