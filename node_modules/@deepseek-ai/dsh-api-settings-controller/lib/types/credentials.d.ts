...
/**
 * What one reference read answered: whether a value resolves, the source layer
 * supplying it, and the value itself while configured.
 */
...
export declare class CredentialsController extends TypertRemoteService {
     ...
     * @throws RemoteError when the request is invalid, no provider is mounted, or the provider refuses the read.
     */
    get(ref: string): Promise<CredentialValueView>;
    /**
