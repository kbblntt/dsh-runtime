				...
				*/
				cacheRead: () => {
					try {
						...
						const valid = parsed !== null && typeof parsed === "object" && parsed.v === 3 && parsed.windowDays === USAGE_WINDOW_DAYS && parsed.sessions !== null && typeof parsed.sessions === "object";
						if (!valid) {
							try {
			...
			(0, react.useEffect)(() => {
				...
				const run = async () => {
					...
					for (const session of ordered) {
						...
						} else if (entry !== null && typeof entry === "object" && typeof entry.seq === "number" && entry.seq < asOf && typeof entry.model === "string" && entry.buckets !== null && typeof entry.buckets === "object") {
							const sub = usageSeedAccumulator(entry, cutoffDay);
							const span = usageSeedSpan(entry, cutoff);
							if (span !== void 0) sub.sessions.push(span);
							plans.push({
