...
/**
 * What one credential reference read answered: whether a value resolves, the
 * source layer supplying it, and the value itself while configured.
 */
export type CredentialValueView = {
    configured: boolean;
    source?: string;
    value?: string;
};
...
export interface ModelsOperations {
    ...
    /**
     * Read one credential reference's stored value for display.
     * @param ref - credential reference name.
     * @returns the resolved value view, or undefined when the read was refused.
     */
    revealCredential(ref: string): Promise<CredentialValueView | undefined>;
    /**
