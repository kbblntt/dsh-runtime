 ...
 /* v8 ignore next 4 -- plain-text composition nests no block elements today; the walk stays total for imported states. */
		...
		*/
		...
		const en = {
			...
			"input.add": "Add attachment or command",
			"input.addAttachment": "Add images",
		...
		*/
		const InputBar = (0, react.memo)(function InputBar({ useSession, useInput, inputActions, keyboard, addImages, removeImage, draftImages, resolveSubmitMode, toggleCommandMenu, stop, command, t, renderSlot, useNotices, useLexicon, useMenuLauncher, useProjection, sessionId, variant, disabled: inert = false, blocked, workspacePickerOpen = false, onRequestWorkspace, placeholder, accessory }) {
			...
			const onAttachmentPicked = (event) => {
			...
			const addItems = [
				...addImages === void 0 ? [] : [{
					id: "attachment",
					label: t("input.addAttachment"),
					icon: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconPaperclipOutline16, {
						size: 14,
						key: "attachment-icon"
					})
				}],
				...toggleCommandMenu === void 0 ? [] : [{
					...
					icon: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconApiOutline14, { key: "command-icon" })
				}]
			];
			const onAddSelect = (id) => {
				setAddMenuOpen(false);
				if (id === "attachment") onPickAttachments();
				else if (id === "command") onToggleCommandMenu();
			};
						...
						children: [
							...
							(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [(0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										addItems.length === 0 ? null : (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Menu, {
											open: addMenuOpen,
											items: addItems,
